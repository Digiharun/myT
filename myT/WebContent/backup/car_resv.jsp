...
<script src="javascript/car_review2.js"></script>
    ...
    <div id="bgtop_car"> <!-- choice / search -->
      ...
      <div id="choice">
        <div class="choice0">차량 예약</div>
       	<div class="choice0 choice2 choice_not"><a class="air_menu" href="car_review.jsp">차량 후기</a></div>
      </div>
      <div id="search_review">
        <div class="search">
           <div class="search2_title">도시 선택</div><div class="search2_title" style="margin-left: 85px">차량 종류</div>
          <div class="search2_title" style="margin-left: 100px">탑승일자</div><!--div class="search2_title" style="margin-left: 70px">검색어</div-->
        ...
        <div class="search3">
          ...
          <select name='car_gbn' class='car_gbn' style="height: 30px; margin-top: 15px;">
          	<option value='0' >선택</option><option value='5' >5인승</option>
			<option value='8' >8인승</option><option value='12' >12인승</option>
          </select>
          <input type="text" class="datepicker" id="dept_d" maxlength="10"   />
