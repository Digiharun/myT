...
<body>
 ...
 <section>
   ...
   <div id="bgtop_car"> <!-- choice / search -->
      <!-- choice : 서비스 선택 탭 -->
      <div id="choice">
        <div class="choice0">글쓰기</div>
       	<!--div class="choice0 choice2 choice_not"><a class="air_menu" href="car_review.jsp">후기 검색</a></div-->
      </div>
      <div id="search_review">
        <form action="car_review3.jsp">
        <div class="search">
           <div class="search2_title">도시 선택</div><div class="search2_title" style="margin-left: 85px">차량 종류</div>
          <div class="search2_title" style="margin-left: 100px">작성자</div><div class="search2_title" style="margin-left: 70px">검색어</div>
        ...
        <div class="search3">
          ...
          <!--button  type="button" class="btn btn_search" id="btn_search" onclick='search()'>검색</button--> 
        </div> 
        <!-- 제목과 후기 입력하는 창 + 입력 삭제 버튼 >
         <div class="search2">
         <div class="div_text">
         	<input type="text" name='cont_title' placeholder="제목을 입력해주세요." maxlength='30' style="width: 1000px" >
         	<textarea id='textarea' name='cont_text' placeholder="후기를 입력해주세요." cols='40' rows='8' maxlength='500' ></textarea>
         </div>
         <div class='div_btn2'><button  type="submit" class="btn" id="btn_ins">입력</button>  
          </div-->   
  ...
  <div id="bg_car">
    <div class="car2">
      <div id='div_title' ><input type="text" name='cont_title' placeholder="제목을 입력해주세요." maxlength='30' id='input_title' ></div>
      <div id='div_textarea' ><textarea id='textarea' name='cont_text' placeholder="후기를 입력해주세요." cols='40' rows='8' maxlength='500' ></textarea></div>
    <div class='bg3' ><button  type="button" class="btn_insert btn_insert2" id="btn_insert" >저장</button></div>
    </div>
    <div>
