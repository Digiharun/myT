...
<html>
	<head>
	   ...
	   <script src="javascript/festvdetail.js"></script> <!--file upload-->
		...
		<!-- 게시물 -->
			...
			<div class="card">
				...
				<div class="btnmom">
					...
					<a href="#ticketingbox" class="ticketingtab">티켓팅</a>
				</div>
...
//				String rrtime = rtime.substring(0, 10);
				...
				%>
					<tr><td class='td'><div class='rvNo'><%=k+1 %></div></td> 
				...
				<div class="ticketbox" id="ticketbox">
					...
					<div class='tinfo'>
						...
						<ul>
							...
							<li>부득이하게 주소 변경이 필요하신 경우 각 배송사에 수취 거절 요청 후, 고객센터(1544-1555)로 재배송 신청할 수 있습니다. (배송비 3,200원 추가 부과)</li>
						</ul>
					</div>
					...
					<div class='tinfo'>
						...
						<ul>
							...
							<li>②번의 경우에도 예매 당일 밤 12시 이전 취소 시에는 취소수수료가 없습니다. (취소기간 내에 한함)</li>
							...
							<li>취소는 관람일 하루 전(평일/주말/공휴일 오후 5시, 토요일 오전 11시 이전)까지 직접 취소가 가능합니다.
								<br>배송이 시작된 티켓의 경우 티켓이 인터파크 티켓 고객센터로 공연 전일까지 반송되어야 취소가능하며,
								<br>취소수수료는 도착일자 기준으로 부과됩니다.
								<br>(※ 단, 배송료는 환불되지 않으며 일괄배송 상품의 경우 취소에 대한 자세한 문의는 고객센터로 문의해주시기 바랍니다.)</li>
						...
						<ul>
							...
							<li>예매 및 예매취소, 티켓 반송 서비스는 소비자기본법에 따른 소비자분쟁 해결기준(공정위 고시)에 따릅니다.</li>
						</ul>
					</div>
					...
					<div class='tinfo'>
						...
						<ul>
							...
							<br>단, 예매자 본인 명의의 계좌가 없을 경우에는 직계 가족 명의의 계좌에 한하여 가능하며, 이 경우 관계를 증명할 수 있는 증빙서류를 예매자 본인이 팩스나 우편 등으로 인터파크 티켓 본사로 보내주셔야 합니다.
						...
						<ul>
							...
							<li>환불 지연 등에 따른 배상급 지급에 대한 사항은 전자상거래 등에서의 소비자 보호에 관한 법률 및 소비자기본법에 따른 소비자분쟁 해결기준(공정위 고시)에 따르며 관련 문의는 고객센터로 연락주시기 바랍니다.</li>
						</ul>
					</div>
					...
					<div class='tinfo'>
						...
						<p class='tsmalltitle'></p>
						<ul>
							<li>입금 시 총 결제금액을 정확히 입금하여야 합니다. 입금금액이 다를 경우 예매내역은 자동취소 되며, 입금된 금액은 추후 환불 처리됩니다.
							<br>2건 이상 예매시에도, 각 예매 건 별로 입금을 하셔야 합니다.</li>
	...
	<div class="ticketingbg">
		...
		<!-- 
resv_no	varchar(20)	YES
user_id	varchar(15)	YES
cl_no	varchar(1)	YES
in_no	varchar(20)	YES
visit_date	varchar(8)	YES
leave_date	varchar(8)	YES
tck_price	int(11)	YES
pay_no	varchar(8)	YES
tck_count	int(11)	YES
		 -->
